...
# 前言
目前能看到的模版大多是達到「管理」的目的，像是冰箱管理、年度計畫管理，還有我做的這個[衣服管理模版](https://www.notion.so/marketplace/templates/clothes-n-outfit)，當然如果在工作中使用絕對是個好工具，但是我相信除了天選之人以外，凡人們（包含我：D）大概很難在日常生活中持續的管理各種生活用品。
...
我的這個[免費模版](https://www.notion.so/marketplace/templates/clothes-n-outfit)是我這個系統的閹割版，但是畫面比自己使用的漂亮許多。這個推薦系統整體會使用到google app script跟Gemini API，所以Notion Marketplace沒辦法完全展示我的功能😎
